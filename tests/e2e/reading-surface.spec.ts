...
// The contrast arithmetic lives in `support/contrast.ts`: the saved-page reader's highlight
// chips are the second surface that had to be measured this way, and one answer to "is this
// legible" is the point of the exercise.
import { worstContrast } from './support/contrast.js';
