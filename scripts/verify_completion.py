...
E2E_TAGS = {
    ...
    # --- milestone 4 (docs/MILESTONE4.md) ---
    "N06": "A thing placed in a notebook survives restart as a block (was: desk cards)",
    "N07": "A dropped file becomes a block without leaving the researcher's disk",
    "N08": "A question's notebook is reached from the queue, and names its question",
    "N09": "The journal expands from its pop-up into a full page of the workspace",
    ...
    "K01": "Two documents are linked from the reader",
    ...
    "E01": "Send to a notebook sits in the reader and lands as a block in the page",
    "E02": "A hypothesis is a link target; evidence attaches by hand",
    "V01": "A wiki highlight carries its text, distinct from a file at a glance",
    ...
    "I01": "Discard sets a notebook aside and it comes back; delete goes to the trash bin",
    ...
    # --- milestone 7 (docs/MILESTONE7.md) ---
    "P06": "Sends and drops land as blocks in the notebook page; the desk is gone",
    "P07": "Blocks are deleted and rearranged by drag",
    "P08": "A new journal day arrives with its first block ready",
    "P09": "The journal opens as a pop-up, and can expand into the full page",
    "P10": "Front matter, sections and hypotheses are sections of the page, not a side panel",
    "P11": "An image in a block is resized by hand",
    "P12": "Cmd+S saves the notebook page",
    "H05": "Linking asks nothing about kind — a link is a link",
    "H06": "The picker expands a document to search its highlights, or says there are none",
    "H07": "A link is deleted wherever it is seen",
    "H08": "A highlight dragged onto the reader beside it links the two",
    "H09": "Dragging between two graph nodes links them",
    "F04": "The wiki opens full-page, docks to a side by its tab, and keeps its scale",
    "F05": "The graph is the wiki focused: one surface, whole or focused",
    "F06": "A wiki highlight shows enough of its text to know what it is",
    "F07": "The librarian pops up from the wiki; it has no sidebar",
    "U09": "Panels and sections minimize and drag-resize; the annotations panel closes",
    "U10": "A search result is clicked and goes there",
    "U11": "Delete moves to a trash bin, and the bin can be emptied",
