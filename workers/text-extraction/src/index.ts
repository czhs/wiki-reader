/**
 * @wr/text-extraction-worker — not yet implemented.
 *
 * Scheduled for milestone criterion M09: PDF text extraction worker.
...
export class NotImplementedError extends Error {
  constructor(what: string) {
    super(`@wr/text-extraction-worker: ${what} is not implemented yet (criterion M09)`);
